...
describe("Spec", function () {
    ...
    describe("class's 'DependencyResolver' spec", function () {
        ...
        it("should resolve registered boolean", function () {
            var value = false;
        ...
        it("should resolve type which has overridden 'toString' function", function () {
        ...
        it("should get constructor arguments from $inject for minified version", function () {
            function Engine() {
            }

            function Turbo() {
            }
            Turbo.prototype.start = jasmine.createSpy();
            Engine.prototype.start = jasmine.createSpy();
            ...
            car.start();
            expect(Engine.prototype.start).toHaveBeenCalled();
            expect(Turbo.prototype.start).toHaveBeenCalled();

        });

        it("should throw an exception if $inject length and arguments length mismatched", function () {
            expect(function () {
                function Car(e,t) {
                    this.start = function () {
                        e.start();
